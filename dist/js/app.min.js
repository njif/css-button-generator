...
!function(t){var n=function(){this._map={}};n.prototype={add:function(t,n){return this._map[t]=n,this},get:function(t){return this._map[t]},toString:function(t){var n=this.get(t);if(!n)return"";var r="";for(var i in n)n.hasOwnProperty(i)&&(r+="   "+i+": "+n[i]+";\n");return r}},t.CssClass=n}(window.cssbutton);
!function(t){t.CssRule=function(t,i,e,s){this._key=t,this._value=i,this._keyPrefixes=e||[],this._valuePrefixes=s||[]},t.CssRule.prototype={key:function(){return this._key},value:function(t){return null==t?this._value:(this._value=t,void(this._string=null))},toString:function(){return this._string?this._string:(this._string=this._createRuleString(),this._string)},_createRuleString:function(){var t,i="";for(t=0;t<kf.length;t++)i+="	"+kf[t]+this._key+": "+v+";\n";for(t=0;t<this._valuePrefixes.length;t++)i+="	"+this._valuePrefixes[t]+this._key+": "+this._value+";\n";return i+="	"+this._key+": "+this._value+";\n",this._string=i,i}}}(window.cssbutton);
...
!function(t,s){var n='		<h2>Result</h2>		<div class="result-button-container">			<button>Button text</button>		</div>',o={buttonText:"Button text",buttonStyle:{border:"solid #3181b4","border-width":"1px","border-radius":"4px","font-family":"MyriadPro-Bold","font-size":"16px","font-weight":"bold","background-color":"#37a1e4",color:"#fff",height:"45px","max-width":"400px","text-shadow":"0 1px rgba(0,0,0,.32)","box-shadow":"0 1px 1px rgba(0,0,0,.19), inset 0 2px rgba(255,255,255,.58), inset 0 0 5px rgba(255,255,255,.38)",outline:"none"}};t.ResultControls=function(t,n){this._holder=t,this._config=s.extend({},o,n),this._controls={button:null},this._btnClass="default-button",this._style=null,this._callbacks={css:[],html:[]},this._init()},t.ResultControls.prototype={onCssChanged:function(s){return t.jstools.subscribe(this,this._callbacks.css,s)},onHtmlChanged:function(s){return t.jstools.subscribe(this,this._callbacks.html,s)},raiseAllCallbacks:function(){this.setText(this._controls.button[0].innerHTML),this.setCss({})},setCss:function(s){var n=this._getButtonCssString(s);t.cssrules.remove("."+this._btnClass),t.cssrules.add("."+this._btnClass,n),t.jstools.publish(this._callbacks.css,"."+this._btnClass+" {\n"+n+"}")},setText:function(n){this._controls.button[0].innerHTML=n,t.jstools.publish(this._callbacks.html,s.trim(this._controls.button.parent().html()))},_getButtonCssString:function(t){return this._config.buttonStyle=s.extend({},this._config.buttonStyle,t),this._style.add(this._btnClass,this._config.buttonStyle),this._style.toString(this._btnClass)},_init:function(){this._holder.html(n),this._controls.button=this._holder.find("button").addClass(this._btnClass),this._style=(new t.CssClass).add(this._btnClass,this._config.buttonStyle),t.cssrules.add("."+this._btnClass,this._style.toString(this._btnClass))}}}(window.cssbutton,jQuery);
