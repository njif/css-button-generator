...
!function(e){var a={addCallbackTo:function(e,a,n){return null!=n&&"function"==typeof n&&a.push(n),null==a.owner&&(a.owner=e),null==a.maxIndex&&(a.maxIndex=1),null!=n&&(n.callbackIndex=a.maxIndex++),e},deleteCallbackFrom:function(e,a,n){if(null!=n&&"function"==typeof n||$Utils.isNullOrEmptyArray(a)){var r=n.callbackIndex;if(r>0){for(var l=[],s=0;s<a.length;s++)a[s].callbackIndex!=r&&l.push(a[s]);if(l.length!=a.length)return l.maxIndex=a.maxIndex,l}}return a},raiseCallbacks:function(e,a){null==a&&(a=[]);for(var n=0;n<e.length;n++)e[n].apply(e.owner,a)},raiseCallbacks1Param:function(e,n){a.raiseCallbacks(e,[n])},parsePostResponse:function(e){var a=$("<div />").html(e).find(".server_response");return a.length>0?a.first():e},validEmail:function(e){var a=/^([a-z0-9_\.-])+@[a-z0-9-]+\.([a-z]{2,4}\.)?[a-z]{2,4}$/i;return a.test(e)},sendEmail:function(e){return a.validEmail(e.email)?void $.ajax({url:"http://cssbutton.e3w.ru/email/send.php",type:"POST",data:{email:e.email,html:e.html,css:e.css},success:function(n){e.done&&e.done({error:!1,message:a.parsePostResponse(n)})},error:function(a){e.done&&e.done({error:!0,message:a.statusText+" (error code: "+a.status+")"})}}):e.done({error:!0,message:"Invalid email"})},addPrefixes:function(e){var a;try{a="undefined"==typeof autoprefixer?e:autoprefixer.process(e).css}catch(n){a=e}return a}},n=e||window;n.jstools={subscribe:a.addCallbackTo,unsubscribe:a.deleteCallbackFrom,publish:a.raiseCallbacks1Param,sendEmail:a.sendEmail,addPrefixes:a.addPrefixes}}(window.cssbutton);
